...
req(any(v in version for v in ('WPI 7.63.5','WPI 7.63.6','WPI 7.63.7','WPI 7.63.8')),'VERSION missing 7.63.5+')
req(site.get('version') in {'7.63.5','7.63.6','7.63.7','7.63.8'},'site release mismatch')
