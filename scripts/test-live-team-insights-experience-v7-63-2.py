...
req('WPI 7.63.2' in version, 'VERSION must identify 7.63.2')
req(site.get('version') == '7.63.2', 'site release must identify 7.63.2')
req(site.get('liveTeamInsightsExperienceRelease') == '7.63.2', 'Team Insights release marker missing')
