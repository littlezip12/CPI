...
req(any(v in version for v in ('WPI 7.63.2','WPI 7.63.3','WPI 7.63.4','WPI 7.63.5')), 'VERSION must preserve 7.63.2')
req(site.get('version') in {'7.63.2','7.63.3','7.63.4','7.63.5'}, 'site release must preserve 7.63.2')
req(site.get('liveTeamInsightsExperienceRelease') in {'7.63.2','7.63.3','7.63.4','7.63.5'}, 'Team Insights release marker missing')
req(site.get('liveSubscriptionPricingRelease') in {'7.63.2','7.63.4','7.63.5'}, 'pricing release marker missing')
