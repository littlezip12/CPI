...
req(site.get('version') in {'7.64.8','7.64.9','7.64.10','7.64.11'},'site version must preserve 7.64.8+')
for key in ('liveScoringGameDayCapAssignmentRelease','liveScoringQuickTimePadRelease','liveScoringGameStoryRelease'):
    req(site.get(key) in {'7.64.8','7.64.9','7.64.10','7.64.11'},f'{key} missing')
...
qtp=(ROOT/('js/live-quick-time-pad-v7-64-11.js' if site.get('version')=='7.64.11' else ('js/live-quick-time-pad-v7-64-9.js' if site.get('version') in {'7.64.9','7.64.10'} else 'js/live-quick-time-pad-v7-64-8.js'))).read_text()
...
engine=(ROOT/('js/live-game-v7-64-11.js' if site.get('version')=='7.64.11' else ('js/live-game-v7-64-9.js' if site.get('version') in {'7.64.9','7.64.10'} else 'js/live-game-v7-64-8.js'))).read_text()
