...
if site.get("version")!="7.56.6": errors.append("site version must be 7.56.6")
if site.get("liveScoringMultiDeviceRelease")!="7.56.6": errors.append("multi-device release marker missing")
if site.get("liveScoringRoleSecurityRelease")!="7.56.6": errors.append("role-security release marker missing")
...
for page,script in (
    ("live-dashboard.html","live-dashboard-v7-56-6.js?v=7.56.6"),
    ("live-login.html","live-login-v7-56-6.js?v=7.56.6"),
    ("live-password-reset.html","live-password-reset-v7-56-6.js?v=7.56.6"),
    ("live-sandbox.html","live-sandbox-v7-56-6.js?v=7.56.6")
):
    text=read(page)
    if 'live-backend-v7-56-6.js?v=7.56.6' not in text: errors.append(f"{page} missing 7.56.6 backend")
    if script not in text: errors.append(f"{page} missing {script}")
    if 'config/live-sandbox.js?v=7.56.6' not in text: errors.append(f"{page} missing 7.56.6 config cache bust")

for rel in ("js/live-backend-v7-56-6.js","js/live-dashboard-v7-56-6.js","js/live-login-v7-56-6.js","js/live-password-reset-v7-56-6.js","js/live-sandbox-v7-56-6.js"):
...
if errors:
    print("WPI SCORER MULTI-DEVICE 7.56.6 TEST FAILED")
    for error in errors: print(f" - {error}")
    sys.exit(1)
print("WPI SCORER MULTI-DEVICE 7.56.6 TEST PASSED")
...
print(" - Private WPI Live assets are cache-busted to 7.56.6")
