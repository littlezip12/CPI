#!/usr/bin/env python3
"""Protect the validated 7.58.0 Club → Teams foundation during 7.58.2."""
...
req(release.get('version')=='7.58.2','current release must be 7.58.2')
...
dashboard=read('js/live-dashboard-v7-58-2.js')
