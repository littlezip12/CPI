...
req(site.get('version') in {'7.64.5','7.64.6','7.64.7'},'site release must preserve 7.64.5 or later')
...
req(site.get('liveScoringOpponentAutocompleteRelease') in {'7.64.5','7.64.6','7.64.7'},'opponent autocomplete marker missing')
