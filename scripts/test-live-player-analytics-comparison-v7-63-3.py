...
req(any(v in version for v in ('WPI 7.63.3','WPI 7.63.4','WPI 7.63.5','WPI 7.63.6','WPI 7.63.7','WPI 7.63.8','WPI 7.63.9','WPI 7.64.0','WPI 7.64.1')), 'VERSION must preserve 7.63.3')
req(site.get('version') in {'7.63.3','7.63.4','7.63.5','7.63.6','7.63.7','7.63.8','7.63.9','7.64.0','7.64.1'}, 'site release must preserve 7.63.3')
req(site.get('liveTeamInsightsExperienceRelease') in {'7.63.3','7.63.4','7.63.5','7.63.6','7.63.7','7.63.8','7.63.9','7.64.0','7.64.1'}, 'Team Insights release marker must preserve 7.63.3')
