...
if release.get('version') != '7.56.4': errors.append('site-release version is not 7.56.4')
...
if errors:
    print("WPI LIVE EVENT DELIVERY 7.56.4 TEST FAILED")
    for error in errors: print(f" - {error}")
    sys.exit(1)

print("WPI LIVE EVENT DELIVERY 7.56.4 TEST PASSED")
...
print(" - WPI Live 7.56.3 browser assets remain protected while the schema release advances to 7.56.4")
