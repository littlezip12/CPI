...
req(site.get('version') in {'7.60.0','7.60.1','7.60.2','7.60.3'},'release metadata mismatch')
...
req(index.get('release') in {'7.60.0','7.60.1','7.60.2','7.60.3'},'schedule index release marker mismatch')
