...
expected_opening = '2026-champions-cup-pacific-zone-qualifier' if site.get('version') in {'7.64.7','7.64.8'} else '2026-evan-cousineau-memorial-cup'
...
expected_next = '2026 Champions Cup Pacific Zone Qualifier' if site.get('version') in {'7.64.7','7.64.8'} else 'Evan Cousineau Memorial Cup'
