...
if site.get('version') not in {'7.52.13','7.52.14','7.52.15','7.52.16','7.53.0','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0','7.54.1','7.54.2','7.54.3','7.54.4','7.54.5','7.54.6','7.54.7','7.54.8','7.54.9','7.54.10','7.54.11','7.54.12','7.54.13','7.54.14','7.54.15','7.54.17','7.54.18','7.55.0','7.55.1'}: fail('site version must be 7.52.13')
if site.get('joProfileRelease')!='7.52.13': fail('joProfileRelease must be 7.52.13')
if site.get('teamProfileRelease') not in {'7.52.13','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0','7.54.1','7.54.2','7.54.3','7.54.4','7.54.5','7.54.6','7.54.7','7.54.8','7.54.9','7.54.10','7.54.11'}: fail('teamProfileRelease must preserve the JO bridge')
if site.get('clubProfileRelease') not in {'7.52.13','7.53.0','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0','7.54.1','7.54.2','7.54.3','7.54.4','7.54.5','7.54.6','7.54.7','7.54.8','7.54.9','7.54.10','7.54.11'}: fail('clubProfileRelease must preserve the JO profile bridge')
if site.get('joResultsRelease')!='7.52.15': fail('joResultsRelease must be 7.52.15')
if site.get('tournamentUIRelease') not in {'7.52.15','7.54.0','7.54.1','7.54.2','7.54.3','7.54.4','7.54.5','7.54.6','7.54.7','7.54.8','7.54.9','7.54.10','7.54.11','7.54.17','7.54.18','7.55.0','7.55.1'}: fail('tournamentUIRelease must preserve JO profile routing while allowing the reusable tournament platform')
...
html_requirements={
 ...
 'club.html':['css/jo-profile-bridge-v7-52-11.css?v=7.53.4','data/tournaments/jo-profile-runtime.js?v=7.53.4','js/club-intelligence-v7-26.js?v=7.54.18'],
 'tournaments.html':['data/tournaments/jo-profile-runtime.js?v=7.53.4','js/tournament-hub-v7-54-4.js?v=7.55.1'],
}
...
for rel,tokens in {
 ...
 'js/team-tournament-history-v7-53-1.js':['findJoProfile','Tournament history','Open complete JO journey'],
 'js/club-intelligence-v7-26.js':['connectedTeams','renderJoClubProfile','Teams and final results'],
 'js/tournament-hub-v7-54-4.js':['window.WPI_JO_PROFILES','joProfiles.lookup','joAsset','joJourney'],
}.items():
    text=(ROOT/rel).read_text(encoding='utf-8')
    for token in tokens:
