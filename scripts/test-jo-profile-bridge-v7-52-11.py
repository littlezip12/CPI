...
if site.get('version') not in {'7.52.13','7.52.14','7.52.15','7.52.16','7.53.0','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0','7.54.1','7.54.2','7.54.3'}: fail('site version must be 7.52.13')
if site.get('joProfileRelease')!='7.52.13': fail('joProfileRelease must be 7.52.13')
if site.get('teamProfileRelease') not in {'7.52.13','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0','7.54.1','7.54.2','7.54.3'}: fail('teamProfileRelease must preserve the JO bridge')
if site.get('clubProfileRelease') not in {'7.52.13','7.53.0','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0','7.54.1','7.54.2','7.54.3'}: fail('clubProfileRelease must preserve the JO profile bridge')
if site.get('joResultsRelease')!='7.52.15': fail('joResultsRelease must be 7.52.15')
if site.get('tournamentUIRelease') not in {'7.52.15','7.54.0','7.54.1','7.54.2','7.54.3'}: fail('tournamentUIRelease must preserve JO profile routing while allowing the reusable tournament platform')
