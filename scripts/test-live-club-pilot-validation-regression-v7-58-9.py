...
req(read('VERSION.md').strip() in {'# WPI 7.58.9 — Club Operations & Scale Polish','# WPI 7.58.10 — Pilot Launch Prep & Admin Safety','# WPI 7.59.0 — Lamorinda Club Pilot Ready','# WPI 7.60.0 — Club Branding Platform','# WPI 7.60.1 — Self-Service Club Onboarding','# WPI 7.60.2 — Team Directory & Identity Management'},'current VERSION mismatch')
req(site.get('version') in {'7.58.9','7.58.10','7.59.0','7.60.0','7.60.1','7.60.2'},'current release must preserve 7.58.9 observability')
...
req(site.get('liveScoringDashboardRelease') in {'7.58.9','7.58.10','7.59.0','7.60.0','7.60.1','7.60.2'},'dashboard release must preserve pilot observability')
...
req(('js/live-dashboard-v7-60-2.js?v=7.60.2' in html) or ('js/live-dashboard-v7-58-10.js?v=7.58.10' in html) or ('js/live-dashboard-v7-58-9.js?v=7.58.9' in html),'current dashboard JS not loaded')
