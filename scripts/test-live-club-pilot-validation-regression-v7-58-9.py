...
req(read('VERSION.md').strip() in {'# WPI 7.58.9 — Club Operations & Scale Polish','# WPI 7.58.10 — Pilot Launch Prep & Admin Safety','# WPI 7.59.0 — Lamorinda Club Pilot Ready','# WPI 7.60.0 — Club Branding Platform','# WPI 7.60.1 — Self-Service Club Onboarding'},'current VERSION mismatch')
req(site.get('version') in {'7.58.9','7.58.10','7.59.0','7.60.0','7.60.1'},'current release must preserve 7.58.9 observability')
...
req(site.get('liveScoringDashboardRelease') in {'7.58.9','7.58.10','7.59.0','7.60.0','7.60.1'},'dashboard release must preserve pilot observability')
