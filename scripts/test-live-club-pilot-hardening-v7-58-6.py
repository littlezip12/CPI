...
req(read('VERSION.md').strip() in {'# WPI 7.58.6 — Club-Level Pilot Hardening','# WPI 7.58.7 — Club Pilot Validation & Observability','# WPI 7.58.8 — Club-Branded Game Experience','# WPI 7.58.9 — Club Operations & Scale Polish','# WPI 7.58.10 — Pilot Launch Prep & Admin Safety'},'VERSION mismatch')
req(site.get('version') in {'7.58.6','7.58.7','7.58.8','7.58.9','7.58.10'},'release metadata mismatch')
...
req(index.get('release') in {'7.58.6','7.58.7','7.58.8','7.58.9','7.58.10'},'current tournament schedule index release mismatch')
