...
req(read('VERSION.md').strip() in {'# WPI 7.58.6 — Club-Level Pilot Hardening','# WPI 7.58.7 — Club Pilot Validation & Observability','# WPI 7.58.8 — Club-Branded Game Experience'},'VERSION mismatch')
req(site.get('version') in {'7.58.6','7.58.7','7.58.8'},'release metadata mismatch')
...
req(index.get('release') in {'7.58.6','7.58.7','7.58.8'},'current tournament schedule index release mismatch')
