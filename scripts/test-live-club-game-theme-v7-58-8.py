#!/usr/bin/env python3
"""Static acceptance checks for WPI Live 7.58.8 Club-Branded Game Experience."""
...
req(read('VERSION.md').strip()=='# WPI 7.58.8 — Club-Branded Game Experience','VERSION mismatch')
req(site.get('version')=='7.58.8' and site.get('name')=='Club-Branded Game Experience','release metadata mismatch')
...
for key,expected in {
    'liveScoringClubPilotValidationRelease':'7.58.7',
...
print('WPI LIVE 7.58.8 CLUB-BRANDED GAME EXPERIENCE TEST PASSED')
