...
CSS_TAG = '<link rel="stylesheet" href="css/premium-homepage-polish.css">'
JS_TAG = '<script src="js/premium-homepage-polish.js"></script>'
...
if text != original:
    ...
    print("index.html already includes Premium Homepage Polish")
