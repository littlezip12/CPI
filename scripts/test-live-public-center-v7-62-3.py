...
req(site.get('version') in {'7.62.3','7.62.4','7.62.5','7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4','7.63.5','7.63.6','7.63.7','7.63.8'},'site version must preserve 7.62.3 or later')
req(site.get('liveScoringPublicLiveCenterRelease')=='7.62.3','public Live Center release metadata missing')
req(any(v in (ROOT/'VERSION.md').read_text() for v in ('7.62.3','7.62.4','7.62.5','7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4','7.63.5','7.63.6','7.63.7','7.63.8')),'VERSION must preserve 7.62.3 or later')
