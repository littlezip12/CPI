...
for key in ('liveScoringDashboardRelease','liveScoringClubOperationsRelease','liveScoringClubOperationsScaleRelease'):
    req(site.get(key) in {'7.58.9','7.58.10','7.59.0','7.60.0','7.60.1','7.60.2','7.60.3','7.61.0','7.61.1','7.62.0','7.62.1','7.62.2','7.62.3','7.62.4','7.62.5','7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4','7.63.5','7.63.6','7.63.7','7.63.8','7.63.9','7.64.0','7.64.1','7.64.2','7.64.3','7.64.4','7.64.5','7.64.6'},f'club operations marker not preserved: {key}')
...
req((('js/live-dashboard-v7-60-3.js?v=7.60.3' in html or 'js/live-dashboard-v7-60-2.js?v=7.60.2' in html)) or ('js/live-dashboard-v7-58-10.js?v=7.58.10' in html) or ('js/live-dashboard-v7-58-9.js?v=7.58.9' in html),'current dashboard JS route missing')
...
req(index.get('release') in {'7.58.9','7.58.10','7.59.0','7.60.0','7.60.1','7.60.2','7.60.3','7.61.0','7.61.1','7.62.0','7.62.1','7.62.2','7.62.3','7.62.4','7.62.5','7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4','7.63.5'},'schedule index release mismatch')
