...
for key in ('liveScoringDashboardRelease','liveScoringClubOperationsRelease','liveScoringClubOperationsScaleRelease'):
    req(site.get(key) in {'7.58.9','7.58.10','7.59.0','7.60.0','7.60.1','7.60.2','7.60.3','7.61.0','7.61.1','7.62.0','7.62.1','7.62.2'},f'club operations marker not preserved: {key}')
...
req(index.get('release') in {'7.58.9','7.58.10','7.59.0','7.60.0','7.60.1','7.60.2','7.60.3','7.61.0','7.61.1','7.62.0','7.62.1','7.62.2'},'schedule index release mismatch')
