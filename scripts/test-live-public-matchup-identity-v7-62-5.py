...
req(site.get('version') in {'7.62.5','7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4'},'site version must preserve 7.62.5 or later')
...
req(any(v in (ROOT/'VERSION.md').read_text() for v in ('7.62.5','7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4')),'VERSION must preserve 7.62.5 or later')
