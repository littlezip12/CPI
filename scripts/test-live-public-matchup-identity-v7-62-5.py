...
req(site.get('version') in {'7.62.5','7.62.6'},'site version must preserve 7.62.5 or later')
...
req(any(v in (ROOT/'VERSION.md').read_text() for v in ('7.62.5','7.62.6')),'VERSION must preserve 7.62.5 or later')
