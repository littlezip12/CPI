...
if site.get('version') not in {'7.54.6','7.54.7'}: fail('site version must preserve Session 3')
...
if hub.get('release') not in {'7.54.5','7.54.6','7.54.7'}: fail('public tournament hub release must preserve Session 3')
