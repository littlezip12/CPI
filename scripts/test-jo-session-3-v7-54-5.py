...
if site.get('version') not in {'7.54.6','7.54.7','7.54.8','7.54.9','7.54.10'}: fail('site version must preserve Session 3')
...
if hub.get('release') not in {'7.54.5','7.54.6','7.54.7','7.54.8','7.54.9','7.54.10'}: fail('public tournament hub release must preserve Session 3')
