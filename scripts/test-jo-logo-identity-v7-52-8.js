...
if(!['7.52.8','7.52.9','7.52.10','7.52.12','7.52.13','7.52.14','7.52.15'].includes(resolver.release))throw new Error(`Expected resolver 7.52.8 or later 7.52.x logo release, found ${resolver.release}.`);
