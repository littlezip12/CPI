...
for token in ('makeHref("methodology.html")','href: "organizations.html"','href: "live-following.html"'):
...
for rel,(headline,modifier) in pages.items():
    ...
    if 'js/site-shell.js?v=7.62.2' not in text: errors.append(f'{rel} has stale shell cache key')
