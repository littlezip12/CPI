...
expected_release_values = {
    ...
    'navigationRelease': {'7.54.13','7.62.2','7.62.3','7.62.4','7.62.5','7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4','7.63.5'},
...
for token in ('makeHref("methodology.html")','href: "organizations.html"','href: "live.html"'):
...
for rel,(headline,modifier) in pages.items():
    ...
    if 'js/site-shell.js?v=7.62.3' not in text: errors.append(f'{rel} has stale shell cache key')
...
print(' - Primary navigation is focused on Rankings, Organizations, Tournaments, and WPI Live; Methodology remains available as supporting content')
