...
if site.get('version') not in {'7.52.13','7.52.14','7.52.15','7.52.16','7.53.0'}: fail('site version must be 7.52.13')
for key in ['rankingDataRelease','identityRelease','joProfileRelease','teamProfileRelease']:
    if site.get(key)!='7.52.13': fail(f'{key} must be 7.52.13')
if site.get('clubProfileRelease') not in {'7.52.13','7.53.0'}: fail('clubProfileRelease must preserve Kern/SKIP profile separation')
