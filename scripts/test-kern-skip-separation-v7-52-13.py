...
if site.get('teamProfileRelease') not in {'7.52.13','7.53.1','7.53.2'}: fail('teamProfileRelease must preserve Kern/SKIP separation')
if site.get('clubProfileRelease') not in {'7.52.13','7.53.0','7.53.1','7.53.2'}: fail('clubProfileRelease must preserve Kern/SKIP profile separation')
