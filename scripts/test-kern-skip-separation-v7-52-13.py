...
if site.get('teamProfileRelease') not in {'7.52.13','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0','7.54.1','7.54.2','7.54.3','7.54.4','7.54.5','7.54.6','7.54.7','7.54.8','7.54.9','7.54.10','7.54.11'}: fail('teamProfileRelease must preserve Kern/SKIP separation')
if site.get('clubProfileRelease') not in {'7.52.13','7.53.0','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0','7.54.1','7.54.2','7.54.3','7.54.4','7.54.5','7.54.6','7.54.7','7.54.8','7.54.9','7.54.10','7.54.11'}: fail('clubProfileRelease must preserve Kern/SKIP profile separation')
...
for rel in ['index.html','rankings.html','clubs.html','club.html','team.html','tournaments.html']:
    if 'data.js?v=7.55.1' not in (ROOT/rel).read_text(): fail(f'{rel} does not load the corrected ranking data cache key')
