...
req('# WPI 7.64.16 — Player Stats Visual Polish' in version,'WPI 7.64. release history missing')
req(site.get('version') in {'7.64.16','7.64.17','7.64.18','7.64.19'},'site release mismatch')
