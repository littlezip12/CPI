...
req(any(v in version for v in ('WPI 7.63.1','WPI 7.63.2','WPI 7.63.3')), 'VERSION must preserve 7.63.1')
req(site.get('version') in {'7.63.1','7.63.2','7.63.3'}, 'site release must preserve 7.63.1')
