...
req(site.get("version") in {"7.62.4", "7.62.5", "7.62.6","7.63.0","7.63.1","7.63.2","7.63.3"}, "site version must be 7.62.4")
...
req(any(v in (ROOT / "VERSION.md").read_text() for v in ("7.62.4", "7.62.5", "7.62.6","7.63.0","7.63.1","7.63.2","7.63.3")), "VERSION must identify 7.62.4")
