...
req(site.get("version") in {"7.62.4", "7.62.5"}, "site version must be 7.62.4")
...
req(any(v in (ROOT / "VERSION.md").read_text() for v in ("7.62.4", "7.62.5")), "VERSION must identify 7.62.4")
