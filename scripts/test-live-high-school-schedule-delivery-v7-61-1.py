...
req(any(v in version for v in ('7.61.1','7.62.0','7.62.1','7.62.2','7.62.3')),'VERSION no longer preserves 7.61.1 behavior')
req(site.get('version') in {'7.61.1','7.62.0','7.62.1','7.62.2','7.62.3'},'site release no longer preserves 7.61.1 behavior')
for marker in [
