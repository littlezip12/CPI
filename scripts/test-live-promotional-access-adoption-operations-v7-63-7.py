...
req(any(v in version for v in ('WPI 7.63.7','WPI 7.63.8','WPI 7.63.9','WPI 7.64.0','WPI 7.64.1','WPI 7.64.2')), 'VERSION missing supported 7.63.7/7.63.8/7.63.9/7.64.0/7.64.1/7.64.2')
req(site.get('version') in ('7.63.7','7.63.8','7.63.9','7.64.0','7.64.1','7.64.2'),'site release mismatch')
