...
req(('WPI 7.63.7' in version) or ('WPI 7.63.8' in version) or ('WPI 7.63.9' in version) or ('WPI 7.64.0','WPI 7.64.1' in version),'VERSION missing supported 7.63.7/7.63.8/7.63.9/7.64.0')
req(site.get('version') in ('7.63.7','7.63.8','7.63.9','7.64.0','7.64.1'),'site release mismatch')
