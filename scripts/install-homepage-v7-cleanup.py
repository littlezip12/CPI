...
CSS_TAG = '<link rel="stylesheet" href="css/homepage-v7-cleanup.css">'
JS_TAG = '<script src="js/homepage-v7-cleanup.js"></script>'
...
if text != original:
    ...
    print("index.html already includes Homepage v7 cleanup")
