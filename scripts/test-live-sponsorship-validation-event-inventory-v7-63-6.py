...
req(any(v in version for v in ('WPI 7.63.6','WPI 7.63.7','WPI 7.63.8','WPI 7.63.9','WPI 7.64.0')),'VERSION missing 7.63.6+')
req(site.get('version') in {'7.63.6','7.63.7','7.63.8','7.63.9','7.64.0'},'site release mismatch')
