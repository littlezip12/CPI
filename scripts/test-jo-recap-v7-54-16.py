...
if site.get('version') in {'7.64.7','7.64.8','7.64.9','7.64.10','7.64.11','7.64.12','7.64.13','7.64.14','7.64.15','7.64.16','7.64.17','7.64.18','7.64.19'}:
    if next_event.get('name')!='2026 Champions Cup Pacific Zone Qualifier' or next_event.get('dateLabel')!='September 27, 2026': errors.append('Pacific Champions Cup qualifier is not configured as the next verified event')
else:
...
if site.get('version') not in {'7.64.7','7.64.8','7.64.9','7.64.10','7.64.11','7.64.12','7.64.13','7.64.14','7.64.15','7.64.16','7.64.17','7.64.18','7.64.19'} and next_event.get('publicPath') is not None: errors.append('Evan Cousineau must remain unlinked until its official schedule is available')
if site.get('version') in {'7.64.7','7.64.8','7.64.9','7.64.10','7.64.11','7.64.12','7.64.13','7.64.14','7.64.15','7.64.16','7.64.17','7.64.18','7.64.19'} and next_event.get('publicPath')!='champions-cup-qualifiers.html#pacific': errors.append('Pacific qualifier must link to its verified tracker')
...
print(' - The verified current-season opener is preserved without fabricating a schedule')
