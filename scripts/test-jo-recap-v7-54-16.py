...
if site.get('version') in {'7.64.7','7.64.8'}:
...
if site.get('version') not in {'7.64.7','7.64.8'} and next_event.get('publicPath') is not None: errors.append('Evan Cousineau must remain unlinked until its official schedule is available')
if site.get('version') in {'7.64.7','7.64.8'} and next_event.get('publicPath')!='champions-cup-qualifiers.html#pacific': errors.append('Pacific qualifier must link to its verified tracker')
