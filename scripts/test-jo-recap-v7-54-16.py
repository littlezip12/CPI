...
if site.get('version')!='7.64.7' and next_event.get('publicPath') is not None: errors.append('Evan Cousineau must remain unlinked until its official schedule is available')
if site.get('version')=='7.64.7' and next_event.get('publicPath')!='champions-cup-qualifiers.html#pacific': errors.append('Pacific qualifier must link to its verified tracker')
