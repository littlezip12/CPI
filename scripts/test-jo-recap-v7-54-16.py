...
if site.get('version') in {'7.64.7','7.64.8','7.64.9','7.64.10','7.64.11','7.64.12','7.64.13'}:
...
if site.get('version') not in {'7.64.7','7.64.8','7.64.9','7.64.10','7.64.11','7.64.12','7.64.13'} and next_event.get('publicPath') is not None: errors.append('Evan Cousineau must remain unlinked until its official schedule is available')
if site.get('version') in {'7.64.7','7.64.8','7.64.9','7.64.10','7.64.11','7.64.12','7.64.13'} and next_event.get('publicPath')!='champions-cup-qualifiers.html#pacific': errors.append('Pacific qualifier must link to its verified tracker')
