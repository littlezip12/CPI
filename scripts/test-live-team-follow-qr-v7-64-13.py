...
assert ('# WPI 7.64.13 — Team Follow & QR Onboarding' in version) or ('# WPI 7.64.15 — Player Roster Accuracy & Parent Privacy' in version) or ('# WPI 7.64.16 — Player Stats Visual Polish' in version) or ('# WPI 7.64.17 — Installable App Experience' in version) or ('# WPI 7.64.18 — Water Polo HQ Brand Foundation' in version)
...
assert ('live-login-v7-64-13.js?v=7.64.13' in login) or ('live-login-v7-64-15.js?v=7.64.15' in login)
