...
assert ('# WPI 7.64.13 — Team Follow & QR Onboarding' in version) or ('# WPI 7.64.15 — Player Roster Accuracy & Parent Privacy' in version) or ('# WPI 7.64.16 — Player Stats Visual Polish' in version) or ('# WPI 7.64.17 — Installable App Experience' in version)
