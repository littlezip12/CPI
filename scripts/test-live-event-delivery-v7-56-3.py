...
for page,script in (
    ("live-dashboard.html","live-dashboard-v7-56-3.js?v=7.56.3"),
    ("live-login.html","live-login-v7-56-3.js?v=7.56.3"),
    ("live-password-reset.html","live-password-reset-v7-56-3.js?v=7.56.3"),
    ("live-sandbox.html","live-sandbox-v7-56-3.js?v=7.56.3")
):
    text=read(page)
    if 'live-backend-v7-56-3.js?v=7.56.3' not in text: errors.append(f"{page} missing backend cache bust")
    if script not in text: errors.append(f"{page} missing {script}")

if 'release: "7.56.3"' not in config: errors.append('active live config missing release 7.56.3')
if release.get('version') != '7.56.3': errors.append('site-release version is not 7.56.3')

for path in ("js/live-backend-v7-56-3.js","js/live-sandbox-v7-56-3.js","js/live-dashboard-v7-56-3.js","js/live-login-v7-56-3.js","js/live-password-reset-v7-56-3.js"):
...
if errors:
    print("WPI LIVE EVENT DELIVERY 7.56.3 TEST FAILED")
    for error in errors: print(f" - {error}")
    sys.exit(1)

print("WPI LIVE EVENT DELIVERY 7.56.3 TEST PASSED")
...
print(" - WPI Live assets are cache-busted to 7.56.3 while rankings and tournament data remain unchanged")
