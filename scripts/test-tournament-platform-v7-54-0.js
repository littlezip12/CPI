...
for(const token of ['data/tournaments/platform/runtime.js?v=7.54.0','js/tournament-platform-v7-54-0.js?v=7.54.0','data-wpi-sponsor-placement="tournament_inline"'])if(!html.includes(token))errors.push(`platform page missing ${token}`);
