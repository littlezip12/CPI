...
following_html=read('live-following.html'); following_js=read('js/live-following-v7-64-13.js' if site.get('version') in {'7.64.13','7.64.14','7.64.15','7.64.16','7.64.17'} else 'js/live-following-v7-63-9.js'); following_css=read('css/live-following-v7-63-9.css')
...
req(site.get('version') in {'7.63.9','7.64.0','7.64.1','7.64.2','7.64.3','7.64.4','7.64.5','7.64.6','7.64.7','7.64.8','7.64.9','7.64.10','7.64.11','7.64.12','7.64.13','7.64.14','7.64.15','7.64.16','7.64.17'},'site release mismatch')
