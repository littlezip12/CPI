...
req(version.startswith('# WPI 7.64.14 — Player Stats Experience') or version.startswith('# WPI 7.64.15 — Player Roster Accuracy & Parent Privacy') or version.startswith('# WPI 7.64.16 — Player Stats Visual Polish') or version.startswith('# WPI 7.64.17 — Installable App Experience') or version.startswith('# WPI 7.64.18 — Water Polo HQ Brand Foundation'),'version mismatch')
req(site.get('version') in ('7.64.14','7.64.15','7.64.16','7.64.17','7.64.18'),'site release mismatch')
