...
js=(ROOT/'js/live-dashboard-v7-57-7.js').read_text()
css=(ROOT/'css/live-sandbox-v7-57-7.css').read_text()
...
check('version',site.get('version')=='7.57.7')
check('name',site.get('name')=='Game-Day Identity & Launch Reliability')
