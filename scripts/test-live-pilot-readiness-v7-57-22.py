...
check('version',site.get('version')=='7.57.22')
check('name',site.get('name')=='Pilot Readiness & Operational Hardening')
...
if errors:
    print('WPI LIVE PILOT READINESS & HARDENING 7.57.22 TEST FAILED')
    for e in errors: print('-',e)
    sys.exit(1)
print('WPI LIVE PILOT READINESS & HARDENING 7.57.22 TEST PASSED')
