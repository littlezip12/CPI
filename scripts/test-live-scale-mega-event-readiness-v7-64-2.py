...
req(site.get('version') in {'7.64.2','7.64.3','7.64.4','7.64.5','7.64.6'},'site release mismatch'); req(any(v in version for v in ('WPI 7.64.2','WPI 7.64.3','WPI 7.64.4','WPI 7.64.5','WPI 7.64.6')),'VERSION missing 7.64.2+')
