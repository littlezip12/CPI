...
for path in ("js/live-backend-v7-56-7.js","js/live-sandbox-v7-56-7.js","js/live-dashboard-v7-56-7.js","js/live-login-v7-56-7.js","js/live-password-reset-v7-56-7.js"):
...
if errors:
    print("WPI LIVE EVENT DELIVERY 7.56.7 TEST FAILED")
    for error in errors: print(f" - {error}")
    sys.exit(1)

print("WPI LIVE EVENT DELIVERY 7.56.7 TEST PASSED")
...
print(" - WPI Live 7.56.7 browser assets remain protected with cross-account Scorer persistence protected")
