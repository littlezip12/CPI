...
for page in ['live.html','live-following.html','live-login.html','live-game.html','live-score.html','live-team-insights.html','live-game-recap.html','live-tournament.html']:
    ...
    req(any(v in html for v in ('live-pwa-v7-64-18.js?v=7.64.18','live-pwa-v7-64-19.js?v=7.64.19','live-pwa-v7-64-22.js?v=7.64.22','live-pwa-v7-64-23.js?v=7.64.23')),f'{page} missing current PWA runtime')
