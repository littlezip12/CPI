...
req(version.startswith('# WPI 7.64.19 — Water Polo HQ Brand System & Release Gate Hardening'),'version mismatch')
req(site.get('version')=='7.64.19','site release mismatch')
...
# Approved corrected art should be used in the site, not the superseded hand-drawn SVG path.
req('wphq-logo-full.png?v=7.64.19' in shell,'shell must use approved production PNG')
