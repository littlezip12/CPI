...
if site.get("version") not in {"7.52.15", "7.52.16", "7.53.0", "7.53.1", "7.53.2", "7.53.3", "7.53.4", "7.53.5", "7.53.6", "7.53.7", "7.54.0"}:
    fail("site version must be 7.52.15")
if site.get("clubWebsiteRelease") not in {"7.52.14", "7.52.16", "7.53.0", "7.53.1", "7.53.2", "7.53.3", "7.53.4", "7.53.5", "7.53.6", "7.53.7", "7.54.0"}:
