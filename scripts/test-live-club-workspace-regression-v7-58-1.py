#!/usr/bin/env python3
"""Protect the validated 7.58.0 Club → Teams foundation during 7.58.1."""
...
req(release.get('version')=='7.58.1','current release must be 7.58.1')
...
dashboard=read('js/live-dashboard-v7-58-1.js')
