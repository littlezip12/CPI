...
req(site.get('version') in {'7.64.4','7.64.5','7.64.6','7.64.7','7.64.8','7.64.9','7.64.10','7.64.11','7.64.12','7.64.13','7.64.14','7.64.15','7.64.16','7.64.17','7.64.18','7.64.19'},'site release must preserve 7.64.4 or later')
...
req(('live-quick-time-pad-v7-64-8.js' in game) or ('live-quick-time-pad-v7-64-9.js' in game) or ('live-quick-time-pad-v7-64-11.js' in game),'game scoring page missing Quick Time Pad successor')
...
qtp=read('js/live-quick-time-pad-v7-64-11.js' if 'live-quick-time-pad-v7-64-11.js' in game else ('js/live-quick-time-pad-v7-64-9.js' if 'live-quick-time-pad-v7-64-9.js' in game else 'js/live-quick-time-pad-v7-64-8.js'))
