...
req(site.get('version') in {'7.64.4','7.64.5','7.64.6','7.64.7','7.64.8'},'site release must preserve 7.64.4 or later')
...
for needle in ('clockConfirmButton','enterkeyhint="done"','live-quick-time-pad-v7-64-8.js','live-mobile-game-ux-v7-64-4.css'):
...
qtp=read('js/live-quick-time-pad-v7-64-8.js')
