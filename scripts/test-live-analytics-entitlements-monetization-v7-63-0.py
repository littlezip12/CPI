...
require(any(v in version for v in ('WPI 7.63.0','WPI 7.63.1','WPI 7.63.2','WPI 7.63.3')), 'VERSION.md no longer preserves 7.63.0')
require(site.get('version') in {'7.63.0','7.63.1','7.63.2','7.63.3'}, 'site-release.json no longer preserves 7.63.0')
require(site.get('version') in {'7.63.0','7.63.1','7.63.2','7.63.3'}, 'site release no longer preserves analytics/entitlements foundation')
