...
require(any(v in version for v in ('WPI 7.63.0','WPI 7.63.1','WPI 7.63.2','WPI 7.63.3','WPI 7.63.4')), 'VERSION.md no longer preserves 7.63.0')
require(site.get('version') in {'7.63.0','7.63.1','7.63.2','7.63.3','7.63.4'}, 'site-release.json no longer preserves 7.63.0')
require(site.get('version') in {'7.63.0','7.63.1','7.63.2','7.63.3','7.63.4'}, 'site release no longer preserves analytics/entitlements foundation')
...
require(any(v in html for v in ('js/live-game-recap-v7-63-0.js?v=7.63.0','js/live-game-recap-v7-63-2.js?v=7.63.2','js/live-game-recap-v7-63-3.js?v=7.63.3')), 'Recap page is not loading the 7.63.x client')
