...
req(any(v in read("VERSION.md") for v in ("7.60.3","7.61.0","7.61.1")),"VERSION mismatch")
req(site.get("version") in {"7.60.3","7.61.0","7.61.1"},"release metadata mismatch")
...
req("Following WPI teams" in dash and "live-following.html" in dash and any(x in dash for x in ("js/live-dashboard-v7-60-3.js?v=7.60.3","js/live-dashboard-v7-61-0.js","js/live-dashboard-v7-61-1.js?v=7.61.1")),"dashboard cross-club Following bridge missing")
...
req(index.get("release") in {"7.60.3","7.61.0","7.61.1"},"schedule index release marker mismatch")
