...
req(any(v in read("VERSION.md") for v in ("7.60.3","7.61.0","7.61.1","7.62.0","7.62.1","7.62.2","7.62.3","7.62.4", "7.62.5")),"VERSION mismatch")
req(site.get("version") in {"7.60.3","7.61.0","7.61.1","7.62.0","7.62.1","7.62.2","7.62.3","7.62.4", "7.62.5"},"release metadata mismatch")
...
req(index.get("release") in {"7.60.3","7.61.0","7.61.1","7.62.0","7.62.1","7.62.2","7.62.3","7.62.4", "7.62.5"},"schedule index release marker mismatch")
