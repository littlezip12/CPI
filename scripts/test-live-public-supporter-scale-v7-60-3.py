...
html=read("live-following.html"); js=read("js/live-following-v7-60-3.js"); backend=read("js/live-team-following-v7-60-3.js"); login=read("js/live-login-v7-60-3.js"); dash=read("live-dashboard.html"); dashjs=read("js/live-dashboard-v7-60-3.js"); recap=read("js/live-game-recap-v7-60-3.js"); gamehtml=read("live-game.html")
req(read("VERSION.md").strip()=="# WPI 7.60.3 — Public / Supporter Experience at Scale","VERSION mismatch")
req((site.get("version"),site.get("name"))==("7.60.3","Public / Supporter Experience at Scale"),"release metadata mismatch")
...
req("Following WPI teams" in dash and "live-following.html" in dash and "js/live-dashboard-v7-60-3.js?v=7.60.3" in dash,"dashboard cross-club Following bridge missing")
...
req(index.get("release")=="7.60.3","schedule index release marker mismatch")
