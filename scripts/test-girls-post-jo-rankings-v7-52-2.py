...
if site.get('version') not in {'7.52.2','7.52.3','7.52.4','7.52.5','7.52.6','7.52.7','7.52.8','7.52.9'}: fail('site release must preserve the 7.52.2 Girls ranking release or a later 7.52.x presentation release')
