...
req(site.get('version') in {'7.58.6','7.58.7','7.58.8','7.58.9','7.58.10','7.59.0'},'current release must preserve 7.58.6 hardening or later')
...
req(index.get('release') in {'7.58.6','7.58.7','7.58.8','7.58.9','7.58.10','7.59.0'},'schedule index should preserve the current live release')
