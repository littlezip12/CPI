...
req("WPI 7.64.1" in version,"VERSION missing 7.64.1")
req(site.get("version")=="7.64.1","site release mismatch")
...
page=read("live-tournament.html"); css=read("css/live-tournament-v7-64-1.css"); js=read("js/live-tournament-v7-64-1.js")
...
req("live-tournament-v7-64-1.css?v=7.64.1" in page and "live-tournament-v7-64-1.js?v=7.64.1" in page,"tournament assets not cache-busted")
for token in ("live_public_tournament_v1","Live now","Upcoming","Recent finals","Tournament records","not official tournament standings","live-score.html?game=","Team page"):
...
live=read("live.html"); discovery=read("js/live-tournament-discovery-v7-64-1.js"); center=read("js/live-public-center-v7-64-1.js")
...
req("live-public-center-v7-64-1.js?v=7.64.1" in live,"7.64.1 public center not loaded")
req("live_public_tournament_catalog_v1" in discovery,"discovery must use catalog RPC")
req("live_public_scoreboard_v2" in center and "Tournament center" in center,"public game cards must link to tournament center")

score_page=read("live-score.html"); score_js=read("js/live-public-score-v7-64-1.js")
req('id="publicScoreTournament"' in score_page,"public score tournament action missing")
req("live-public-score-v7-64-1.js?v=7.64.1" in score_page,"7.64.1 public score script not loaded")
