...
req(any(v in version for v in ("WPI 7.64.1","WPI 7.64.2","WPI 7.64.3","WPI 7.64.4","WPI 7.64.5","WPI 7.64.6","WPI 7.64.7")),"VERSION missing 7.64.1+")
req(site.get("version") in {"7.64.1","7.64.2","7.64.3","7.64.4","7.64.5","7.64.6","7.64.7","7.64.8","7.64.9","7.64.10","7.64.11","7.64.12","7.64.13","7.64.14","7.64.15","7.64.16","7.64.17","7.64.18","7.64.19"},"site release mismatch")
...
page=read("live-tournament.html"); css=read("css/live-tournament-v7-64-1.css"); js=read("js/live-tournament-v7-64-2.js" if site.get("version") in {"7.64.2","7.64.3","7.64.4","7.64.5","7.64.6","7.64.7","7.64.8","7.64.9","7.64.10","7.64.11","7.64.12","7.64.13","7.64.14","7.64.15","7.64.16","7.64.17","7.64.18","7.64.19"} else "js/live-tournament-v7-64-1.js")
...
live=read("live.html"); discovery=read("js/live-tournament-discovery-v7-64-1.js"); center=read("js/live-public-center-v7-64-2.js" if site.get("version") in {"7.64.2","7.64.3","7.64.4","7.64.5","7.64.6","7.64.7","7.64.8","7.64.9","7.64.10","7.64.11","7.64.12","7.64.13","7.64.14","7.64.15","7.64.16","7.64.17","7.64.18","7.64.19"} else "js/live-public-center-v7-64-1.js")
...
score_page=read("live-score.html"); score_js=read("js/live-public-score-v7-64-2.js" if site.get("version") in {"7.64.2","7.64.3","7.64.4","7.64.5","7.64.6","7.64.7","7.64.8","7.64.9","7.64.10","7.64.11","7.64.12","7.64.13","7.64.14","7.64.15","7.64.16","7.64.17","7.64.18","7.64.19"} else "js/live-public-score-v7-64-1.js")
