...
if site.get('version') not in {'7.54.0','7.54.1','7.54.2','7.54.3','7.54.4','7.54.5','7.54.6','7.54.7','7.54.8','7.54.9','7.54.10','7.54.11','7.54.12','7.54.13'}: errors.append('site version must preserve the platform foundation')
...
for token in ['id="tpAge"','id="tpGender"','id="tpDivision"','id="tpTeam"','id="tpDate"','id="tpVenue"','id="tpStatus"','id="tpSearch"','id="tpJourney"','tournament-platform-v7-54-0.js?v=7.54.11']:
...
if source_event.get('platformEnabled') is not True or source_event.get('platformRelease') not in {'7.54.0','7.54.1','7.54.2','7.54.3','7.54.4','7.54.5','7.54.6','7.54.7','7.54.8','7.54.9','7.54.10','7.54.11'}: errors.append('source registry does not register Quiksilver platform migration')
