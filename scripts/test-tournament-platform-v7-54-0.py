...
if site.get('quiksilverPlatformRelease') not in {'7.54.0','7.54.1','7.54.2','7.54.3','7.54.4'}: errors.append('quiksilverPlatformRelease must preserve the Quiksilver migration')
if site.get('tournamentPlatformRelease') not in {'7.54.0','7.54.1','7.54.2','7.54.3','7.54.4'}: errors.append('tournamentPlatformRelease must preserve the shared platform')
if site.get('tournamentRegistryRelease') not in {'7.54.0','7.54.1','7.54.2','7.54.3','7.54.4'}: errors.append('tournamentRegistryRelease must preserve the shared registry')
if site.get('version') not in {'7.54.0','7.54.1','7.54.2','7.54.3','7.54.4'}: errors.append('site version must preserve the platform foundation')
if registry.get('release') not in {'7.54.0','7.54.1','7.54.2','7.54.3','7.54.4'} or len(registry.get('events',[]))!=5: errors.append('platform registry must contain five registered events')
...
if source_event.get('platformEnabled') is not True or source_event.get('platformRelease') not in {'7.54.0','7.54.1','7.54.2','7.54.3','7.54.4'}: errors.append('source registry does not register Quiksilver platform migration')
