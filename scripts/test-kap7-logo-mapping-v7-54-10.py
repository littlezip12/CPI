...
if site.get('version') != '7.54.10':
    errors.append('site version must be 7.54.10')
if site.get('kap7LogoMappingRelease') != '7.54.10':
    errors.append('kap7LogoMappingRelease must be 7.54.10')
if bundle.get('release') != '7.54.10':
    errors.append('KAP7 platform bundle must be rebuilt for 7.54.10')
