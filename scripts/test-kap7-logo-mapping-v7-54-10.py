...
if site.get('version') not in {'7.54.11','7.54.12','7.54.13','7.54.14','7.54.15'}:
...
if bundle.get('release') != '7.54.11':
    errors.append('KAP7 platform bundle must be rebuilt for 7.54.11')
