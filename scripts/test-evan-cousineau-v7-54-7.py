...
if site.get('version') not in {'7.54.7','7.54.8','7.54.9','7.54.10','7.54.11','7.54.12','7.54.13','7.54.14','7.54.15','7.54.17','7.54.18'}: errors.append('site version must preserve the 7.54.7 Evan Cousineau release')
...
if bundle.get('event',{}).get('season')!='2025' or bundle.get('event',{}).get('startDate')!='2025-10-04' or bundle.get('event',{}).get('endDate')!='2025-10-05': errors.append('event dates/season are incorrect')
...
if not event or event.get('year')!=2025 or event.get('seasonOrder')!=10 or event.get('mode')!='platform': errors.append('2025 archive registration is incorrect')
