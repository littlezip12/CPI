...
for(const token of [
  ...
  'event.persisted',
  'CPI relay is still catching up',
...
for(const token of [
  'Refresh active Boys JO divisions',
...
requireCondition(policy.scheduledEventScope==='2026-jo-weekend-2','Boys event scope is missing');
...
requireCondition(semverAtLeast(site.version,'7.51.6')&&['7.51.6','7.52.7','7.52.8','7.52.9'].includes(site.joApplicationRelease),'Site metadata predates the 7.51.6 JO application');
