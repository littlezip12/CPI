...
requireCondition(semverAtLeast(site.version,'7.51.6')&&['7.51.6','7.52.7','7.52.8','7.52.9','7.53.4','7.54.5','7.54.6','7.54.7','7.54.8'].includes(site.joApplicationRelease),'Site metadata predates the current JO application');
