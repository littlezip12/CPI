...
req(release.get('version') in {'7.58.6','7.58.7','7.58.8','7.58.9','7.58.10','7.59.0','7.60.0','7.60.1','7.60.2'},'current release must preserve 7.58.6 or later')
...
req(('js/live-game-recap-v7-58-4.js?v=7.58.7' in recap or 'js/live-game-recap-v7-58-4.js?v=7.58.6-recapfix1' in recap),'permanent recap route changed unexpectedly')
