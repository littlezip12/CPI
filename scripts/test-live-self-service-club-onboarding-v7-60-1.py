...
req(read('VERSION.md').strip()=='# WPI 7.60.1 — Self-Service Club Onboarding','VERSION mismatch')
req((site.get('version'),site.get('name'))==('7.60.1','Self-Service Club Onboarding'),'release metadata mismatch')
...
req(index.get('release')=='7.60.1','schedule index release marker mismatch')
