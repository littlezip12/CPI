...
assert any(h in version for h in ('# WPI 7.64.12 — Team Stats Home Entry','# WPI 7.64.13 — Team Follow & QR Onboarding','# WPI 7.64.14 — Player Stats Experience','# WPI 7.64.15 — Player Roster Accuracy & Parent Privacy','# WPI 7.64.16 — Player Stats Visual Polish'))
