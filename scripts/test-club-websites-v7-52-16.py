...
if site.get('version') not in {'7.52.16','7.53.0','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0','7.54.1','7.54.2','7.54.3','7.54.4','7.54.5','7.54.6','7.54.7'}: fail('site version must preserve the 7.52.16 website audit')
...
if 'js/tournament-hub-v7-54-4.js?v=7.54.7' not in (ROOT/'tournaments.html').read_text(encoding='utf-8'): fail('public tournament archive consumer missing')
if errors:
