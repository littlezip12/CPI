...
req(any(v in version for v in ('WPI 7.63.8','WPI 7.63.9','WPI 7.64.0','WPI 7.64.1','WPI 7.64.2','WPI 7.64.3','WPI 7.64.4')),'VERSION missing 7.63.8 or later')
req(site.get('version') in {'7.63.8','7.63.9','7.64.0','7.64.1','7.64.2','7.64.3','7.64.4'},'site release mismatch')
