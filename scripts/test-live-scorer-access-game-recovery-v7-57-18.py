...
check('version',site.get('version')=='7.57.18')
check('name',site.get('name')=='Scorer Access & Game Recovery')
check('dashboard release',site.get('liveScoringDashboardRelease')=='7.57.18')
check('promotion release',site.get('liveScoringScorerPromotionRelease')=='7.57.18')
check('recovery release',site.get('liveScoringGameRecoveryRelease')=='7.57.18')
check('notes release',site.get('liveScoringGameNotesRelease')=='7.57.18')
check('actions ux release',site.get('liveScoringGameActionsUxRelease')=='7.57.18')
