...
for token in ('release: "7.56.7"','groupMeDelivery: "connected"','mode: "connected"','supabasePublishableKey'):
...
for token in ('id="groupMeAdminPanel"','id="groupMeDisplayName"','id="groupMeSecretName"','id="groupMeEnabled"','id="saveGroupMeButton"','id="testGroupMeButton"','id="groupMeAudit"','id="dashboardDeliveryMetric"','js/live-dashboard-v7-56-7.js?v=7.56.7'):
...
dash_js=read("js/live-dashboard-v7-56-7.js")
...
if errors:
    print("WPI GROUPME DELIVERY 7.56.7 TEST FAILED")
    for error in errors: print(f" - {error}")
    sys.exit(1)
print("WPI GROUPME DELIVERY 7.56.7 TEST PASSED")
