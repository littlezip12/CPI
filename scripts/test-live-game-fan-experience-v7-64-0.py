...
site=json.loads(read("config/site-release.json"));version=read("VERSION.md");html=read("live-game.html");active_js="js/live-fan-experience-v7-64-1.js" if site.get("version") in {"7.64.1","7.64.2","7.64.3","7.64.4","7.64.5","7.64.6"} else "js/live-fan-experience-v7-64-0.js";js=read(active_js);active_css="css/live-fan-experience-v7-64-1.css" if site.get("version") in {"7.64.1","7.64.2","7.64.3","7.64.4","7.64.5","7.64.6"} else "css/live-fan-experience-v7-64-0.css";css=read(active_css)
req(any(v in version for v in ("WPI 7.64.0","WPI 7.64.1","WPI 7.64.2","WPI 7.64.3","WPI 7.64.4","WPI 7.64.5","WPI 7.64.6")),"VERSION missing 7.64.0+ fan baseline")
req(site.get("version") in {"7.64.0","7.64.1","7.64.2","7.64.3","7.64.4","7.64.5","7.64.6"},"site release mismatch")
