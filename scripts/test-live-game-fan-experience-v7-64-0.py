...
site=json.loads(read("config/site-release.json"));version=read("VERSION.md");html=read("live-game.html");active_js="js/live-fan-experience-v7-64-1.js" if site.get("version") in {"7.64.1","7.64.2","7.64.3","7.64.4","7.64.5","7.64.6","7.64.7","7.64.8","7.64.9","7.64.10","7.64.11","7.64.12","7.64.13","7.64.14","7.64.15","7.64.16","7.64.17","7.64.18","7.64.19"} else "js/live-fan-experience-v7-64-0.js";js=read(active_js);active_css="css/live-fan-experience-v7-64-1.css" if site.get("version") in {"7.64.1","7.64.2","7.64.3","7.64.4","7.64.5","7.64.6","7.64.7","7.64.8","7.64.9","7.64.10","7.64.11","7.64.12","7.64.13","7.64.14","7.64.15","7.64.16","7.64.17","7.64.18","7.64.19"} else "css/live-fan-experience-v7-64-0.css";css=read(active_css)
req(any(v in version for v in ("WPI 7.64.0","WPI 7.64.1","WPI 7.64.2","WPI 7.64.3","WPI 7.64.4","WPI 7.64.5","WPI 7.64.6","WPI 7.64.7")),"VERSION missing 7.64.0+ fan baseline")
req(site.get("version") in {"7.64.0","7.64.1","7.64.2","7.64.3","7.64.4","7.64.5","7.64.6","7.64.7","7.64.8","7.64.9","7.64.10","7.64.11","7.64.12","7.64.13","7.64.14","7.64.15","7.64.16","7.64.17","7.64.18","7.64.19"},"site release mismatch")
...
fan_src="js/live-fan-experience-v7-64-1.js?v=7.64.1" if "js/live-fan-experience-v7-64-1.js?v=7.64.1" in html else "js/live-fan-experience-v7-64-0.js?v=7.64.0-launch-stability-1"; scorer_src=("js/live-game-v7-64-11.js?v=7.64.11" if "js/live-game-v7-64-11.js?v=7.64.11" in html else ("js/live-game-v7-64-9.js?v=7.64.9" if "js/live-game-v7-64-9.js?v=7.64.9" in html else ("js/live-game-v7-64-8.js?v=7.64.8" if "js/live-game-v7-64-8.js?v=7.64.8" in html else "js/live-game-v7-58-6.js?v=7.58.6"))); req(html.index(fan_src)>html.index(scorer_src),"fan layer must load after scorer engine")
