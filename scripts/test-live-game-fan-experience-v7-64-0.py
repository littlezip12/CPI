...
req(site.get("version") in {"7.64.0","7.64.1","7.64.2","7.64.3","7.64.4","7.64.5","7.64.6","7.64.7","7.64.8"},"site release mismatch")
...
fan_src="js/live-fan-experience-v7-64-1.js?v=7.64.1" if "js/live-fan-experience-v7-64-1.js?v=7.64.1" in html else "js/live-fan-experience-v7-64-0.js?v=7.64.0-launch-stability-1";scorer_src="js/live-game-v7-64-8.js?v=7.64.8" if "js/live-game-v7-64-8.js?v=7.64.8" in html else "js/live-game-v7-58-6.js?v=7.58.6";req(html.index(fan_src)>html.index(scorer_src),"fan layer must load after scorer engine")
