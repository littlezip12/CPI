...
required_index = [
    'css/homepage-wpi-v7-52-4.css?v=7.53.3',
    'js/homepage-wpi-v7-52-4.js?v=7.53.3',
...
if site.get('version') not in {'7.52.4','7.52.5','7.52.6','7.52.7','7.52.8','7.52.9','7.52.10','7.52.11','7.52.12','7.52.13','7.52.14','7.52.15','7.52.16','7.53.0','7.53.1','7.53.2','7.53.3'}: errors.append('site release must preserve the 7.52.4 homepage or a later 7.52.x data release')
if site.get('homepageRelease') not in {'7.52.4','7.53.3'}: errors.append('homepageRelease must preserve the original homepage data experience or the 7.53.3 clarity release')
