...
check('current version',site.get('version')=='7.58.5')
check('current name',site.get('name')=='Tournament Feed → Game-Day Validation')
...
check('game script route','js/live-game-v7-58-4.js?v=7.58.5' in html)
