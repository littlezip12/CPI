...
if site.get('version') not in {'7.52.7','7.52.8','7.52.9','7.52.10','7.52.11','7.52.12','7.52.13','7.52.14'}: fail('site release must preserve JO results links 7.52.7 or later')
for key in ['joResultsRelease','tournamentUIRelease','joJourneyRelease','joLogoRelease']:
    if site.get(key) not in {'7.52.7','7.52.8','7.52.9','7.52.10','7.52.11','7.52.12','7.52.13','7.52.14'}: fail(f'{key} must preserve JO results links 7.52.7 or later')
