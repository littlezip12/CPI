...
if site.get('version') not in {'7.52.7','7.52.8','7.52.9','7.52.10','7.52.11','7.52.12','7.52.13','7.52.14','7.52.15','7.52.16','7.53.0','7.53.1','7.53.2','7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0'}: fail('site release must preserve JO results links 7.52.7 or later')
...
if site.get('tournamentUIRelease') not in {'7.52.15','7.54.0'}: fail('tournamentUIRelease must preserve JO results links while allowing the reusable tournament platform')
