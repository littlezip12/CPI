...
if site.get("version") in {"7.62.2","7.62.3","7.62.4", "7.62.5", "7.62.6","7.63.0","7.63.1","7.63.2","7.63.3",'7.63.4','7.63.5','7.63.6','7.63.7','7.63.8','7.63.9','7.64.0','7.64.1','7.64.2','7.64.3','7.64.4','7.64.5','7.64.6','7.64.7','7.64.8','7.64.9','7.64.10','7.64.11','7.64.12','7.64.13','7.64.14','7.64.15','7.64.16','7.64.17','7.64.18','7.64.19'}:
    if "org.profileHref || `organization.html?organization=${encodeURIComponent(org.organizationId)}`" not in palette:
        fail("universal search does not route clubs through the current Organization profile")
else:
