...
if not ids_2026 or ids_2026[0]!='2026-san-diego-county-cup' or ids_2026[-1]!='2026-junior-olympics': errors.append(f'2026 water polo season order is incorrect: {ids_2026}')
js=(ROOT/'js/tournament-platform-v7-54-0.js').read_text(encoding='utf-8')
for token in ['const RELEASE = "7.54.8"','Score unavailable','data-team']:
