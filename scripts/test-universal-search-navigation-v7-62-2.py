...
req(site_release.get('version') in ('7.62.2','7.62.3','7.62.4','7.62.5','7.62.6'),'site release metadata must preserve 7.62.2 or later')
req(site_release.get('navigationRelease') in ('7.62.2','7.62.3','7.62.4','7.62.5','7.62.6'),'navigation release metadata must preserve 7.62.2 or later')
