...
req(site_release.get('version') in ('7.62.2','7.62.3'),'site release metadata must preserve 7.62.2 or later')
req(site_release.get('navigationRelease') in ('7.62.2','7.62.3'),'navigation release metadata must preserve 7.62.2 or later')
