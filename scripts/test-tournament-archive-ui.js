...
const elements = {
  "#archiveGenerated": element(), "#archiveState": element(), "#archiveStats": element(),
  "#archiveEvents": element(), "#archiveScope": element(), "#archiveEvent": element("all"),
  "#archiveDivision": element("all"), "#archiveStatus": element("all"), "#archiveAge": element("all"),
  "#archiveGender": element("all"), "#archiveSearch": element(""), "#archiveCount": element(),
  "#archiveGames": element()
};
...
const context = { window, document, console, Date, URLSearchParams, location, history };
...
req(elements["#archiveEvents"].innerHTML.includes("Girls Futures Super Finals"), "Archive UI did not render Girls Futures Super Finals");
...
req(
  elements["#archiveGames"].innerHTML.includes("archive-team-link") ||
  elements["#archiveGames"].innerHTML.includes("archive-team-side"),
  "Archive team/profile rendering did not initialize"
);
console.log("TOURNAMENT ARCHIVE UI TESTS PASSED");
console.log(" - All seven completed tournaments render from the normalized archive runtime");
