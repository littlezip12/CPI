...
assert cfg['version'] in {'7.53.4','7.53.5','7.53.6','7.53.7','7.54.0'}
assert cfg['homepageRelease'] in {'7.53.3','7.53.4','7.53.5','7.53.6','7.53.7','7.54.0'}
assert cfg['navigationRelease'] in {'7.53.4','7.53.5','7.53.6','7.53.7','7.54.0'}
...
print(f'WPI 7.54.0 navigation/homepage regression passed ({len(html_files)} HTML pages checked).')
