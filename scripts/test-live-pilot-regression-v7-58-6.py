...
check('current version',site.get('version') in {'7.58.6','7.58.7','7.58.8','7.58.9'})
check('current name',site.get('name') in {'Club-Level Pilot Hardening','Club Pilot Validation & Observability','Club-Branded Game Experience','Club Operations & Scale Polish'})
