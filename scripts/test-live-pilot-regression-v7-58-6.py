...
check('current version',site.get('version') in {'7.58.6','7.58.7','7.58.8'})
check('current name',site.get('name') in {'Club-Level Pilot Hardening','Club Pilot Validation & Observability','Club-Branded Game Experience'})
