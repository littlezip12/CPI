...
handoff = read("js/live-scorer-handoff-v7-56-8.js")
...
dashboard = read("js/live-dashboard-v7-56-8.js")
login = read("js/live-login-v7-56-8.js")
...
require(handoff_html, "live-scorer-handoff-v7-56-8.js", "handoff landing page")
...
require(dashboard, 'workspace?.role === "owner" ? $("groupMeSecretName").value.trim() : null', "admin-hidden GroupMe secret")
...
print("WPI GUEST SCORER HANDOFF 7.56.8 TEST PASSED")
...
_pgcrypto_sql_files = [
    ...
    ROOT / "supabase/WPI_LIVE_7_56_8_FULL_SETUP.sql",
