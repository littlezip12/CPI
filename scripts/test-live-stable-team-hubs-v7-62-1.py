...
req(site.get('version') in ('7.62.1','7.62.2','7.62.3','7.62.4','7.62.5','7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4','7.63.5'),'site version must preserve 7.62.1 team hubs or later')
req(any(v in (ROOT/'VERSION.md').read_text() for v in ('7.62.1','7.62.2','7.62.3','7.62.4','7.62.5','7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4','7.63.5')),'VERSION must preserve 7.62.1 team hubs or later')
...
req('live-following-v7-62-1.js?v=7.62.1' in (ROOT/'live-following.html').read_text(),'My Teams must load stable team-hub bridge')
