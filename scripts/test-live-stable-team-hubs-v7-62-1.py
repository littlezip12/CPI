...
req(site.get('version') in ('7.62.1','7.62.2','7.62.3','7.62.4'),'site version must preserve 7.62.1 team hubs or later')
req(any(v in (ROOT/'VERSION.md').read_text() for v in ('7.62.1','7.62.2','7.62.3','7.62.4')),'VERSION must preserve 7.62.1 team hubs or later')
