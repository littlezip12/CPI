...
requireCondition(elements["#opsRows"].innerHTML.includes("Historical / registered"), "Operations UI did not distinguish historical tournaments");
...
console.log(" - Historical tournaments remain visible without being misrepresented as live-monitored");
