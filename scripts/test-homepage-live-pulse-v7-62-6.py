...
req(site.get('version') in {'7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4','7.63.5','7.63.6'},'site version must preserve 7.62.6 or later')
...
req(any(v in (ROOT/'VERSION.md').read_text() for v in ('7.62.6','7.63.0','7.63.1','7.63.2','7.63.3','7.63.4','7.63.5','7.63.6')),'VERSION must preserve 7.62.6 or later')
