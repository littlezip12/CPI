...
CSS_TAG = '<link rel="stylesheet" href="css/newsletter-footer.css">'
JS_TAG = '<script src="js/newsletter-footer.js"></script>'
...
if text != original:
    ...
    print("index.html already includes Newsletter/Footer v2")
