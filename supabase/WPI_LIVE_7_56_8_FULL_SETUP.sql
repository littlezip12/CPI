-- WPI 7.56.8 complete connected live backend setup.
...
-- Contains no API secrets or GroupMe credentials. GroupMe bot IDs/access tokens remain Edge Function secrets.
