/* WPI 7.56.7 — connected scoring with reliable event-delivery dispatch and recovery.
...
(() => {
  ...
  const RELEASE = "7.56.7";
  const STORAGE_KEY = "wpi-live-sandbox-v7-56-7";
  ...
  const AUTH_KEY = "wpi-live-auth-v7-56-7";
