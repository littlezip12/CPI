/* WPI 7.64.11 — Fast Scorekeeping + exact-time pad for goals/penalties + game/event cap controls. */
(() => {
  "use strict";
  ...
  primary.addEventListener("change",()=>{
    ...
    if(requiresExactTime()) requestAnimationFrame(openPad);
    else requestAnimationFrame(submitRoutineIfReady);
  });
