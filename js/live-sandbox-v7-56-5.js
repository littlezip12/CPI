/* WPI 7.56.5 — connected scoring with reliable event-delivery dispatch and recovery.
...
(() => {
  ...
  const STORAGE_KEY = "wpi-live-sandbox-v7-56-5";
  const LEGACY_STORAGE_KEYS = ["wpi-live-sandbox-v7-56-3","wpi-live-sandbox-v7-56-2","wpi-live-sandbox-v7-56-1","wpi-live-sandbox-v7-56-0","wpi-live-sandbox-v7-55-9", "wpi-live-sandbox-v7-55-8", "wpi-live-sandbox-v7-55-6", "wpi-live-sandbox-v7-55-5", "wpi-live-sandbox-v7-55-4", "wpi-live-sandbox-v7-55-3", "wpi-live-sandbox-v7-55-2"];
  const AUTH_KEY = "wpi-live-auth-v7-56-5";
  const LEGACY_AUTH_KEYS = ["wpi-live-auth-v7-56-3","wpi-live-auth-v7-56-2","wpi-live-auth-v7-56-1","wpi-live-auth-v7-56-0","wpi-live-auth-v7-55-9", "wpi-live-auth-v7-55-8", "wpi-live-auth-v7-55-6", "wpi-live-auth-v7-55-5", "wpi-live-auth-v7-55-4", "wpi-live-auth-v7-55-3"];
