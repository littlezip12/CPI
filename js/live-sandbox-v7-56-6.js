/* WPI 7.56.6 — connected scoring with reliable event-delivery dispatch and recovery.
...
(() => {
  ...
  const RELEASE = "7.56.6";
  const STORAGE_KEY = "wpi-live-sandbox-v7-56-6";
  const LEGACY_STORAGE_KEYS = ["wpi-live-sandbox-v7-56-5","wpi-live-sandbox-v7-56-3","wpi-live-sandbox-v7-56-2","wpi-live-sandbox-v7-56-1","wpi-live-sandbox-v7-56-0","wpi-live-sandbox-v7-55-9", "wpi-live-sandbox-v7-55-8", "wpi-live-sandbox-v7-55-6", "wpi-live-sandbox-v7-55-5", "wpi-live-sandbox-v7-55-4", "wpi-live-sandbox-v7-55-3", "wpi-live-sandbox-v7-55-2"];
  const AUTH_KEY = "wpi-live-auth-v7-56-6";
  const LEGACY_AUTH_KEYS = ["wpi-live-auth-v7-56-5","wpi-live-auth-v7-56-3","wpi-live-auth-v7-56-2","wpi-live-auth-v7-56-1","wpi-live-auth-v7-56-0","wpi-live-auth-v7-55-9", "wpi-live-auth-v7-55-8", "wpi-live-auth-v7-55-6", "wpi-live-auth-v7-55-5", "wpi-live-auth-v7-55-4", "wpi-live-auth-v7-55-3"];
  ...
  function renderScorerControl() {
    ...
    if (readOnlyScorer) {
      notice.textContent = control.activeDisplayName
  ...
  async function createScorerHandoffPass() {
    ...
    try {
      ...
      $("scorerHandoffMessage").textContent = "Scan the QR code, or open the fallback link and enter the six-digit code.";
      ...
      if (window.QRCode) {
        ...
        qrNode.textContent = "QR generation did not load. Use Copy link or the fallback code.";
      }
  ...
  function applyRoleAccess() {
    ...
    const isViewer = ["viewer","guest_viewer"].includes(role);
