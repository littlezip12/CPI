/* WPI 7.57.16 — Account Registry Transparency.
 * Connected-only auth surface; Supporter-first registration and operational signup-data notice.
 */
(() => {
  "use strict";
  ...
  async function initConnectedMode() {
    ...
    try {
      ...
      if (!signupAllowed) {
        $("loginExplanation").textContent = "Sign in with an existing account. New accounts require a private team invitation and join with Supporter access first.";
      }
    } catch (error) {
