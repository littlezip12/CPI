/* WPI 7.56.1 — connected email/password gateway. */
(() => {
  "use strict";

  const config = window.WPI_LIVE_SANDBOX_CONFIG || {};
  const AUTH_KEY = "wpi-live-auth-v7-56-1";
  const LEGACY_AUTH_KEYS = ["wpi-live-auth-v7-56-0","wpi-live-auth-v7-55-9","wpi-live-auth-v7-55-8","wpi-live-auth-v7-55-7","wpi-live-auth-v7-55-6","wpi-live-auth-v7-55-5","wpi-live-auth-v7-55-4","wpi-live-auth-v7-55-3"];
