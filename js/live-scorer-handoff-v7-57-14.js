/* WPI 7.57.14 — canonical WPI Live game route for the validated Guest Scorer Pass flow. */
(() => {
  "use strict";
  ...
  async function acceptPass() {
    ...
    try {
      ...
      window.location.replace(`live-game.html?game=${encodeURIComponent(result.gameId)}&guest=1`);
    } catch (error) {
