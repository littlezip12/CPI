(function () {
  ...
  function renderClubProfile() {
    ...
    if (!club) {
      root.innerHTML = `<section class="club-profile-not-found">
        ...
        <div class="club-profile-actions">
          <a class="club-intel-btn" href="clubs.html">Explore clubs</a>
          <a class="club-intel-btn secondary" href="rankings.html">View rankings</a>
        </div>
      </section>`;
      return;
    }
    ...
    <nav class="club-profile-tabs" aria-label="Club profile sections">
      ...
      <a href="#club-best-wins">Best wins</a>
    </nav>
    ...
    <section id="club-age-groups" class="club-profile-table-card club-age-section">
      ...
      <p class="club-profile-note">Use this club ladder to move between age groups and quickly compare a club’s ranked teams across CPI.</p>
    </section>
    ...
    <section class="club-profile-grid">
      ...
      <aside id="club-best-wins" class="club-profile-side-card">
