/* WPI 7.57.3 — multi-team aware login copy on the validated 7.56.8 auth gateway. */
(() => {
  "use strict";
  ...
  function setMode(nextMode) {
    ...
    $("loginExplanation").textContent = signingUp
      ? "Use your own email and password. Access to each team is controlled by Owner, Admin, Scorer, and Viewer roles."
