(() => {
  ...
  function render(data) {
    ...
    if (!hasDetailedAnalytics) {
      const locked = '<p class="live-recap-empty"><strong>Team Insights</strong><br>Detailed player analytics are private. Upgrade to unlock lineups, player production, the complete event timeline, weekend totals and season analytics.</p>';
