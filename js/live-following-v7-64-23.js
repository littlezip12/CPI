/* WPI 7.64.23 — My Teams native first-run polish. */
(() => {
  "use strict";
  const RELEASE="7.64.23";
  ...
  function renderDirectory(){
    ...
    if(!hasFilter){$("directoryResults").innerHTML='<div class="follow-discovery-empty"><strong>Start with your team name.</strong><span>Type a club, school or team above. WPI will narrow the directory as you type instead of showing every team at once.</span></div>';$("directoryResultNote").textContent=`${filtered.length} teams available · search to narrow`;return;}
  ...
  async function applySharedTeamLink(){
    ...
    if(existing){$("followingMessage").textContent=existing.isMember?"This team is already one of your WPI teams.":"This team is already in My Teams.";return;}
