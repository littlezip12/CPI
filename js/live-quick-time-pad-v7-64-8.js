/* WPI 7.64.8 — Event-first Quick Time Pad + game/event cap assignment controls. */
(() => {
  "use strict";
  ...
  const display = $("wpiQuickTimeDisplay"), hint=$("wpiQuickTimeHint"), error=$("wpiQuickTimeError"), quickAssist=$("wpiQuickAssist"), quickAssistWrap=$("wpiQuickAssistWrap"), record=$("wpiQuickTimeRecord");
