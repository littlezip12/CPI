/* WPI 7.56.11 — Live UI Polish built on the validated 7.56.10 reliability baseline.
...
(() => {
  ...
  const RELEASE = "7.56.11";
  const STORAGE_KEY = "wpi-live-sandbox-v7-56-11";
  const LEGACY_STORAGE_KEYS = ["wpi-live-sandbox-v7-56-10","wpi-live-sandbox-v7-56-9","wpi-live-sandbox-v7-56-8","wpi-live-sandbox-v7-56-5","wpi-live-sandbox-v7-56-3","wpi-live-sandbox-v7-56-2","wpi-live-sandbox-v7-56-1","wpi-live-sandbox-v7-56-0","wpi-live-sandbox-v7-55-9", "wpi-live-sandbox-v7-55-8", "wpi-live-sandbox-v7-55-6", "wpi-live-sandbox-v7-55-5", "wpi-live-sandbox-v7-55-4", "wpi-live-sandbox-v7-55-3", "wpi-live-sandbox-v7-55-2"];
  const AUTH_KEY = "wpi-live-auth-v7-56-11";
  ...
  const QUICK_EVENT_ACTIONS = [
    {id:"goal", label:"Goal", eventId:"goal", icon:"goal"},
    {id:"save", label:"Save", eventId:"save", icon:"save"},
    {id:"steal", label:"Steal", eventId:"steal", icon:"steal"},
    {id:"exclusion", label:"Exclusion", variants:["exclusion_drawn","exclusion_committed"], icon:"exclusion"},
  ...
  async function endGame({skipConfirm = false} = {}) {
    ...
    try {
      ...
      if (backend && workspace) {
        ...
        setSyncStatus("Final saved", "saved");
      }
