/* WPI 7.57.14 canonical WPI Live game surface.
 * Scoring/event/delivery behavior remains the validated WPI 7.56.15 engine.
 * This copy changes only product-facing route/copy and removes the local-demo/reset surface.
 */
(() => {
  "use strict";
