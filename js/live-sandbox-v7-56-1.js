...
(() => {
  ...
  const RELEASE = "7.56.1";
  const STORAGE_KEY = "wpi-live-sandbox-v7-56-1";
  const LEGACY_STORAGE_KEYS = ["wpi-live-sandbox-v7-56-0","wpi-live-sandbox-v7-55-9", "wpi-live-sandbox-v7-55-8", "wpi-live-sandbox-v7-55-6", "wpi-live-sandbox-v7-55-5", "wpi-live-sandbox-v7-55-4", "wpi-live-sandbox-v7-55-3", "wpi-live-sandbox-v7-55-2"];
  const AUTH_KEY = "wpi-live-auth-v7-56-1";
  const LEGACY_AUTH_KEYS = ["wpi-live-auth-v7-56-0","wpi-live-auth-v7-55-9", "wpi-live-auth-v7-55-8", "wpi-live-auth-v7-55-6", "wpi-live-auth-v7-55-5", "wpi-live-auth-v7-55-4", "wpi-live-auth-v7-55-3"];
  ...
  async function authorize() {
    ...
    try {
      ...
      $("connectionDetail").textContent = `${session.user.email} · ${workspace.role} · ${workspace.teamName}`;
