(() => {
  ...
  function render(data) {
    ...
    if (!hasDetailedAnalytics) {
      $("recapNarrative").textContent = "The final score and period progression are available to Supporters. Detailed player recap content is private and will be available through Team Insights.";
    ...
    if (!hasDetailedAnalytics) {
      const locked = '<p class="live-recap-empty"><strong>Team Insights</strong><br>Detailed player analytics are private. Team Insights will unlock lineups, player production and the complete event timeline.</p>';
      $("recapLineups").innerHTML = locked;
      $("recapPlayerStats").innerHTML = locked;
      $("recapEventCount").textContent = "Private";
      $("recapTimeline").innerHTML = locked;
    } else {
