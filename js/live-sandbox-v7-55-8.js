/* WPI 7.55.8 — team-specific roster and submit-play quarter flow.
...
(() => {
  ...
  const RELEASE = "7.55.8";
  const STORAGE_KEY = "wpi-live-sandbox-v7-55-8";
  const LEGACY_STORAGE_KEYS = ["wpi-live-sandbox-v7-55-6", "wpi-live-sandbox-v7-55-5", "wpi-live-sandbox-v7-55-4", "wpi-live-sandbox-v7-55-3", "wpi-live-sandbox-v7-55-2"];
  const AUTH_KEY = "wpi-live-auth-v7-55-8";
